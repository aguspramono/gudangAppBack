...
class MerkController extends ResourceController
{
    ...
    public function index()
    {
        ...
        $data = [
            'message' => 'success',
            'countmerk' => $this->Merk->like('Merek', $wherelike)->countAllResults()
        ];
    ...
    public function getmerkbyid()
    {
        ...
        $data = [
            'message' => 'success',
            'datamerk' => $this->Merk->where('Merek', $wherelike)->findAll()
        ];
    ...
    public function getMerk()
    {
        ...
        $data = [
            'message' => 'success',
            'datamerk' => $this->Merk->like('Merek', $wherelike)->limit(intval($page), intval($pageprev))->findAll()
        ];
    ...
    public function deletedata()
    {
        ...
        $this->Merk->where('Merek', $id)->delete();
        $response = ['message' => 'success'];
